<template>
  <v-app>
    ...
    <v-app-bar app color="primary" dark>
      ...
      <v-toolbar-title>Burma 2D Admin Dashboard</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-btn icon>
...
const menuItems = [
  ...
  { title: 'Gift Management', icon: 'mdi-gift', route: '/gifts' },
  ...
  { title: 'History Management', icon: 'mdi-history', route: '/history' },
  { title: 'Send Notification', icon: 'mdi-bell-ring', route: '/notifications' },
